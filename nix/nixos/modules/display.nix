# NOTE: From this commit https://github.com/DaRacci/nix-config/commit/07caa0f46dd3e482767714aab1f93e25e5bfbab2
      ...
      edid = {
        ...
        packages = [
          (pkgs.runCommand "edid-virtual" { } ''
            ...
            base64 -d "${cfg.edidBinary}" > "$out/lib/firmware/edid/virtual.bin"
            )
          '')
        ];
      };
